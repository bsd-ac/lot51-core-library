...
class AffordanceLockOutSnippet(
    ...
    INSTANCE_TUNABLES = {
        "version": Tunable(
            ...
            allow_empty=True,
            default="1",
            description="The schema version of AffordanceLockOutSnippet",
        ),
        ...
        "lock_out": TunableList(
            tunable=TunableTuple(
                ...
                compatibility_type=TunableEnumEntry(
                    ...
                    default=LockCompatibilityType.ANY,
                ),
                interval=TunableInterval(
                    description="Time in sim minutes in which this affordance will not be valid for.",
