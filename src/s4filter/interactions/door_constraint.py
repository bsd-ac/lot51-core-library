...
class TunedDoorConstraint(ZoneConstraintMixin):
    ...
    def create_zone_constraint(
        ...
        circle_constraint = Circle(
            position,
            self._line_of_sight.max_line_of_sight_radius,
            routing_surface=routing_surface,
            ideal_radius=self._ideal_radius,
        )
...
class TunableDoorConstraint(TunableSingletonFactory):
    ...
    def __init__(
        self,
        description="A tunable type for creating a constraint inside or outside the front door",
        callback=None,
        **kwargs,
    ):
        ...
        super().__init__(
            ...
            ideal_radius=Tunable(
                description="ideal distance for this front door constraint, points closer to the ideal distance will score higher.",
                tunable_type=float,
                default=2,
            ),
            ...
            front_door_position_option=TunableEnumEntry(
                ...
                tunable_type=FrontDoorOption,
                default=FrontDoorOption.OUTSIDE_FRONT_DOOR,
            ),
