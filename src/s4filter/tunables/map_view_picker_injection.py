        ...
        if self.additional_venue_inclusion is not None:
            ...
            if default_inclusion is None:
                ...
                if hasattr(default_inclusion, "exclude_venues"):
                    overrides.exclude_venues = merge_list(
                        default_inclusion.exclude_venues,
                        custom_inclusion.exclude_venues,
                    )
                ...
                if hasattr(default_inclusion, "include_venues"):
                    overrides.include_venues = merge_list(
                        default_inclusion.include_venues,
                        custom_inclusion.include_venues,
                    )
