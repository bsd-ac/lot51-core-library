...
class TunableBuffInjection(BaseTunableInjection):
    FACTORY_TUNABLES = {
        ...
        "game_effect_modifiers": TunableList(
            description="A list of game effect modifiers",
            ...
            if self.provided_template_affordances is not None:
                if buff_type.provided_template_affordances is None:
                    ...
                    merged_template_affordances = merge_list(
                        buff_type.provided_template_affordances.template_affordances,
            ...
            if self.interaction_items is not None:
                if buff_type.interactions is not None:
                    inject_dict(
                        buff_type,
                        "interactions",
                        interaction_items=merge_list(
                            buff_type.interactions.interaction_items,
                            self.interaction_items,
                            list_type=tuple,
                        ),
                    )
                else:
                    buff_type.interactions = self._create_interaction_items(
                        {
