...
class TunableCommandArgumentVariant(TunableVariant):
    def __init__(self, **kwargs):
        super().__init__(
            boolean=Tunable(tunable_type=bool, default=False),
            string=Tunable(tunable_type=str, default=""),
            num_float=Tunable(tunable_type=float, default=0.0),
            num_int=Tunable(tunable_type=int, default=0),
