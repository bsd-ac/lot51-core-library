    ...
    FACTORY_TUNABLES = {
        ...
        "types_of_posts": TunableList(
            ...
            tunable=TunableTuple(
                post_type=TunableEnumEntry(
                    description="A SocialMediaPostType enum entry.",
                ...
                loots_on_post=TunableList(
                    ...
                    tunable=TunableReference(
                        ...
                        description="A loot applied to the actor when the post is made.",
                        pack_safe=True,
                    ),
                ),
                target_loots_on_post=TunableList(
                    ...
                    tunable=TunableReference(
                        manager=get_instance_manager(Types.ACTION),
                        description="A loot applied to the target when the post is made.",
                        pack_safe=True,
                    ),
                ),
            ),
